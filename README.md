...
The total number of particpants should be evenly divided into groups for input. In a real world scenario, virutal participants can be considered as group fillers, or a couple people can be the unfortuante few who have to grouop with one of the same people twice. 
