...
This program has some limitations and may not be able to solve some of the more extensive cases in a blink of the eye. For instance, in a social golf scenario with 24 participants divided into 8 groups (of 4 players each) the number of rounds/days it can be solved for is 10, but this program can only work out 9 of the rounds in a split second. Getting 10 rounds complete, may take it a minute.
